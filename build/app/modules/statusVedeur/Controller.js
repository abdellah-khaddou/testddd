...
let statusVedeurCtrl = class statusVedeurCtrl extends Controller_1.default {
    constructor(options) {
        super(options);
        this.moduleDB = options.statusVedeurRepository['statusVedeur'];
    }
    async seed(params) {
...
], statusVedeurCtrl.prototype, "seed", null);
__decorate([
    action_metadata_1.endPoint({}),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], statusVedeurCtrl.prototype, "search", null);
__decorate([
    action_metadata_1.endPoint({}),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], statusVedeurCtrl.prototype, "delete", null);
__decorate([
    action_metadata_1.endPoint({}),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], statusVedeurCtrl.prototype, "duplicate", null);
__decorate([
    action_metadata_1.endPoint({
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], statusVedeurCtrl.prototype, "save", null);
statusVedeurCtrl = __decorate([
    module_metadata_1.Module({
        inputs: [
            providers_1.getInjection('statusVedeurRepository').statusVedeurSchema.getModuleValidator,
            Middlewares_1.middleware.authenticateUser,
        ]
    }),
    __metadata("design:paramtypes", [Object])
], statusVedeurCtrl);
exports.default = statusVedeurCtrl;
